...
def download_stanford_corenlp(data_dir="data"):
    if os.path.isdir(os.path.join(data_dir, "stanford-corenlp-full-2017-06-09")):
        print("Already have Stanford CoreNLP downloaded and unzipped. Not redownloading.")
        return
    zip_file_name = os.path.join(data_dir, constants.CORENLP_ZIP_FILE_NAME)
